...
<html lang="en">
  <head>
    ...
    <title> <?php echo $title; ?> | Nigerian Defense Academy, Kaduna</title>
    ...
    <link rel="icon" href="../../../../static/nda-logo.png" type="image/x-icon"/>
    <link rel="shortcut icon" href="../../../../static/nda-logo.png" type="image/x-icon"/>
    <!-- CSS files -->
